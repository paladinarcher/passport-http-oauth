...
exports.plaintext = function(consumerSecret, tokenSecret) {
  //if(!tokenSecret) { return exports.encode(consumerSecret); }
  return [exports.encode(consumerSecret), exports.encode(tokenSecret)].join('&');
  //return exports.encode([exports.encode(consumerSecret), exports.encode(tokenSecret)].join('&'));
  // this is getting retarded...
  //return exports.encode(consumerSecret);
}
